...
namespace Atrai.Data.Repository
{
    ...
    public class DynamicReportRepository : BaseRepository<DynamicReport>, IDynamicReportRepository
    {
    ...
    public class PaymentTermsRepository : SelfRepository<PaymentTerms>, IPaymentTermsRepository
    {
    ...
    public class IncoTermRepository : SelfRepository<TradeTerm>, IIncoTermRepository
    {
    ...
    public class ShipModeRepository : BaseRepository<ShipMode>, IShipModeRepository
    {
    ...
    public class DayListTermRepository : BaseRepository<DayListTerm>, IDayListTermRepository
    {
