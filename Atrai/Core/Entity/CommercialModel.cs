...
namespace Atrai.Core.Entity
{
    ...
    public partial class MasterLCModel:BaseModel
    {
        ...
        public virtual TradeTerm TradeTerm { get; set; }
    ...
    public partial class ExportInvoicePackingList:BaseModel
    {
        ...
        [Display(Name = "CBM")]
        public decimal? CBMLinePacking { get; set; }
    ...
    public class DayListTerm:BaseModel
    {
        [StringLength(100)]
    ...
    public class TradeTerm : SelfModel
    {
        [StringLength(100)]
        [Display(Name = "Trade Term")]
    ...
    public class PaymentTerms : SelfModel
    {
        [StringLength(100)]
        [Display(Name = "Payment Terms")]
    ...
    public class BankAccountNoLienBank:SelfModel
    {
        [StringLength(100)]
        [Display(Name = "Bank Account No")]
        public string BankAccountNumber { get; set; }
