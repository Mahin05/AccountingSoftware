...
{
    [Table("Categorytest")]
    public class CategoryModeltest : BaseModel
    {
        [Required]
        [StringLength(30)]
    ...
    public partial class Cat_Strength : SelfModel
    {
        ...
        public virtual ICollection<Cat_DesignationModel> Cat_Designation { get; set; }
        public virtual ICollection<Cat_SectionModel> Cat_Section { get; set; }
    }

    public partial class Hr_RawData : BaseModel
    {
        [StringLength(15)]
    ...
    public partial class HR_RawData_App : SelfModel
    {
    ...
    public partial class HR_Emp_EducationModel : BaseModel
    {
        [Display(Name = "Employee")]
        public int EmpId { get; set; }
        [ForeignKey("EmpId")]
    ...
    public partial class HR_Emp_ExperienceModel : BaseModel
    {
    ...
    public partial class HR_Emp_FamilyModel : BaseModel
    {
    ...
    public partial class HR_Emp_NomineeModel : BaseModel
    {
    ...
    public partial class HR_Emp_PersonalInfoModel : BaseModel
    {
        ...
        public virtual Acc_FiscalYearModel PFFinalYear { get; set; }
        ...
        public virtual Acc_FiscalYearModel PFFundTransferYear { get; set; }
        ...
        public virtual Acc_FiscalYearModel WFFinalYear { get; set; }
        ...
        public virtual Acc_FiscalYearModel WFFundTransferYear { get; set; }
        ...
        public virtual Acc_FiscalYearModel GratuityFinalYear { get; set; }
        ...
        public virtual Acc_FiscalYearModel GratuityFundTransferYear { get; set; }
    ...
    public partial class HR_Emp_PF_OPBalModel : BaseModel
    {
        [Display(Name = "Employee")]
        public int EmpId { get; set; }
        [ForeignKey("EmpId")]
        ...
        public virtual Acc_FiscalYearModel PFOPBalYear { get; set; }
    ...
    public partial class HR_Emp_BankInfo : BaseModel
    {
        //[Key]
        //[DatabaseGenerated(DatabaseGeneratedOption.Identity)]
        ...
        public virtual Cat_PayModeModel Cat_PayMode { get; set; }

        [Display(Name = "A/C Type")]
        public int? AccTypeId { get; set; }
        [ForeignKey("AccTypeId")]
        public virtual Cat_AccountTypeModel Cat_AccountType { get; set; }

        [Display(Name = "Bank Name")]
        public int? BankId { get; set; }
        [ForeignKey("BankId")]
        public virtual Cat_BankModel Cat_Bank { get; set; }

        [Display(Name = "Branch Name")]
        public int? BranchId { get; set; }
        [ForeignKey("BranchId")]
        public virtual Cat_BankBranchModel Cat_BankBranch { get; set; }
    ...
    public partial class HR_Leave_Avail : BaseModel
    {
        //[Key]
        //[DatabaseGenerated(DatabaseGeneratedOption.Identity)]
        ...
        [ForeignKey("LTypeId")]
        public virtual Cat_Leave_TypeModel Cat_Leave_Type { get; set; }
    ...
    public partial class HR_Emp_Increment : BaseModel
    {
        //[Key]
        //[DatabaseGenerated(DatabaseGeneratedOption.Identity)]
    ...
    public partial class HrAttFixed : BaseModel
    {
        //[Key]
        //[DatabaseGenerated(DatabaseGeneratedOption.Identity)]
    ...
    //public partial class HrEarnLeave : BaseModel
    //{
    //    [Key]
    //    [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
    ...
    public partial class HrEmpIncr : BaseModel
    {
        [Key]
        [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
    ...
    public partial class HR_Emp_Salary : BaseModel
    {
        ...
        public int? BId { get; set; }
        [ForeignKey("BId")]
        public virtual Cat_BuildingTypeModel Cat_BuildingTypeHC { get; set; }
    ...
    public partial class HrLeaveAvail : BaseModel
    {
        public long EmpId { get; set; }
        public DateTime? DtInput { get; set; }
        public DateTime DtFrom { get; set; }
    ...
    public partial class HR_ProcessedData : BaseModel
    {
        ...
        public float ROTAmt { get; set; }
        public float EOTAmt { get; set; }
    ...
    public partial class HR_ProssType : BaseModel
    {
    ...
    //    public virtual Acc_FiscalYearModel Acc_FiscalMonths { get; set; }
    ...
    //    public int EmpId { get; set; }
    //    [ForeignKey("EmpId")]
    //    public EmployeeModel HR_Emp_Info { get; set; }
