...
namespace Atrai.Controllers
{
    public class ValuesController : Controller
    {
        ...
        ISalesBatchItemsRepository salesBatchItemsRepository,
        ...
        IOrdersRepository ordresRepository, ITaskToDoRepository taskToDoRepository,
        IMobileTextAnimationRepository mobileTextAnimationRepository, IColorRepository colorRepository,
        ...
        public ActionResult LogIn(string UserName, string Password, string Latitude, string Longitude, int? ComId)
        {
            try
            {
                ...
                if (userinfo != null)
                {
                    ...
                    return Ok(new { UserName = userinfo.Name, Token = userinfo.Token, UserId = userinfo.Id, ComId = ComId, userinfo.Email, compnayinfo.CompanyName, RoleName = rolename.UserRole.RoleName, WeightScaleBarcodeStartWith = "99", EmpImagePath = rolename?.EmployeeList?.EmployeeImagePath, CompanyUserList = companyuserlist, IsSerialSales = true, DecimalField = storeinfo.DecimalField, BusinessTypeName = storeinfo.BusinessType.BusinessTypeName, DefaultCurrencyId = storeinfo.CountryId,
        ...
        public ActionResult SaleReport(int saleId, string format = "PDF", int isfile = 0)
        {
            ...
            //AppData.AppDataDynamic ReportInfo = new AppData.AppDataDynamic();
        ...
        public JsonResult ExternalPayment(int? packageid, string useremailaddress, string browserId, string amount, string transactionid)
        {
            ...
            else
            {
                ...
                if (prevActivation == null)
                {
                    ...
                    activation.LuserId = getuserbyemailaddress.LuserId;
